...
abstract class $ServiceInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int serviceId, String name, String? baseUrl});
}
...
class _$ServiceInfoImpl implements _ServiceInfo {
  const _$ServiceInfoImpl(
      {required this.serviceId, required this.name, this.baseUrl});
  ...
  @override
  String toString() {
    return 'ServiceInfo(serviceId: $serviceId, name: $name, baseUrl: $baseUrl)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, serviceId, name, baseUrl);
...
abstract class _ServiceInfo implements ServiceInfo {
  const factory _ServiceInfo(
      ...
      final String? baseUrl}) = _$ServiceInfoImpl;
